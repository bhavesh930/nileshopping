...
?>
        ...
        <div class="c-sidebar-brand">
            <!-- <img class="c-sidebar-brand-full" src="{{ url('/assets/brand/coreui-base-white.svg') }}" width="118" height="46" alt="Nile Shopping"> -->
            <!-- <img class="c-sidebar-brand-minimized" src="{{ url('assets/brand/coreui-signet-white.svg') }}" width="118" height="46" alt="Nile Shopping"> -->
            <div><strong>Nile Shopping</strong></div>
        </div>
